export const STRINGS = {
  en: {
    ...
    keepScreenOn: "Keep your screen on during the session — the timer may pause otherwise.",
    previous: "Previous",
  ...
  bg: {
    ...
    voiceFemale: "Женски",
    voiceMale: "Мъжки",
    chimeVolume: "Сила на звука",
    voiceVolume: "Сила на гласа",
    keepScreenOn: "Дръжте екрана включен по време на сесията — иначе таймерът може да спре.",
    previous: "Предишна",
    replayVoice: "Пусни гласа отново",
    preview: "Пробвай",
    pause: "Пауза",
    resume: "Продължи",
    stop: "Стоп",
